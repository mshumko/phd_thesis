...
\begin{equation}
B(L, \lambda) = \frac{31.2 \ \mathrm{\mu T}}{L^3}\sqrt{1 + 3 \sin^2 \lambda}.
\end{equation} The change in $v^2_{\perp}$ can be found by taking the ratio of $B(L, \lambda)$ at two different $L$ shells
