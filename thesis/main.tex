...
\DocTitle{Connecting Microburst Precipitation To Its Scattering Mechanism} 
...
\keys{Microburst, Magnetosphere, Whistler-mode chorus, CubeSat, FIREBIRD, AeroCube 6, Van Allen Probes} 
...
\include{2_mageis_microburst}
\include{3_bouncing_microburst}
\include{4_ac6_microburst}
...
\appendix
\include{2_appendix_mageis_microburst}
\include{3_appendix_bouncing_microburst}
\include{4_appendix_ac6_microburst}
