...
\begin{equation}
J_2 = \oint p_{||} ds
\end{equation} where $ds$ describes the particle trajectory between the mirror points in the northern and southern hemispheres. This integral can be numerically evaluated in a dipole field and the  
