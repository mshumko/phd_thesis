...
The single-particle motion described in the previous section is a prerequisite to understanding how these particles organize into macroscopic structures in the magnetosphere. The overall outer magnetosphere structure is shown in Fig. \ref{Intro:outer_magnetosphere}.
...
\end{figure}
 ...
 We will take a tour of the magnetosphere by first focusing on the solar drivers and then 

With the background in single-particle motion we can start to look at how these particles are organized in the mag
